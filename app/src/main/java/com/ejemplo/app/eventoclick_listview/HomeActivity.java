...
public class HomeActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String emailcapturado = extras.getString("emaildigitado");
        setTitle(emailcapturado);

        //1.Conectar nuestro lustView al componente visual a través del Id
        ...
        //5. Gestión evento Click en la lista
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Toast.makeText(HomeActivity.this, "La versión seleccionada es: " + androidVersion, Toast.LENGTH_SHORT).show();
